...
trainData = {
    ...
    size = function() return (#trainData.data)[1]/10 end
}
...
testData = {
    data = loaded.data,
    labels = loaded.labels,
    size = function() return (#testData.data)[1]/10 end
}
...
model:add(nn.Linear(ninput,nhidden*2))
model:add(nn.ReLU())
model:add(nn.Linear(nhidden*2,nhidden))
